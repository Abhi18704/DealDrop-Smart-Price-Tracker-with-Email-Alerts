...
export async function GET(){
  return NextResponse.json({message:"price check endpoint is working. Use this to trigger price checks."});
}
  ...
  try{
    ...
    for(const product of products){
      try{
        ...
        const newPrice=praseFloat(productData.currentPrice);
        const oldPrice=praseFloat(product.current_price);
